defmodule IslandsEngine.Rules do
  ...
  # :gen_statem setup functions begin here
  ...
  # :gen_statem setup functions end here

  # State callback functions a.k.a state_functions begin here
  ...
  def players_set({:call, from}, :show_current_state, _state_data) do
    {:keep_state_and_data, {:reply, from, :player_set}}
  end
  ...
  def player_set(_event, _caller_pid, state) do
  ...
  # State Functions ends here

  # Client Functions begin here
  ...
  # Client functions end here

  # Private auxiliary functions start here

  defp set_islands_reply(from, state_data, status, status) when status == :islands_set do
    {:next_state, :player1_turn, state_data, {:reply, from, :ok}}
  end
  ...
  # Private auxiliary functions ends here
end
